      ...
      <div style={{
        ...
        <ul style={{
          ...
          <li style={{ marginBottom: '1rem', paddingLeft: '1.5rem', position: 'relative' }}>
            ...
            <strong style={{ color: 'var(--green-primary)' }}>Trusted Information:</strong> Clear, evidence-based guidance on the 12 major chronic conditions affecting Americans today.
          </li>
          <li style={{ marginBottom: '1rem', paddingLeft: '1.5rem', position: 'relative' }}>
            <span style={{
              position: 'absolute',
            ...
            <strong style={{ color: 'var(--green-primary)' }}>Interactive Tools:</strong> Self-assessments, videos, and checklists that help you understand risks and take the next step.
          </li>
          <li style={{ marginBottom: '1rem', paddingLeft: '1.5rem', position: 'relative' }}>
            <span style={{
              position: 'absolute',
            ...
            <strong style={{ color: 'var(--green-primary)' }}>Lifestyle Change Programs:</strong> Access to local and virtual resources that support lasting behavior change.
          </li>
          <li style={{ marginBottom: '1rem', paddingLeft: '1.5rem', position: 'relative' }}>
            <span style={{
              position: 'absolute',
            ...
            <strong style={{ color: 'var(--green-primary)' }}>Stories and Learning:</strong> Real-world examples of people making changes that work for them.
          </li>
        </ul>
