...
const exerciseSnacks = [
  ...
  { title: '10-min walk after each meal', desc: 'Three post-meal walks = 30 minutes of targeted blood sugar management. One of the highest-impact, lowest-barrier habits available.', dotColor: '#E05A4D', dark: true },
];
